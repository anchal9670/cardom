          ...
          <div className="grid lg:grid-cols-2 items-start gap-16">
            <form>
              <div className="space-y-4">
                ...
                <button
                  type="button"
                  className="text-white bg-primary-500 hover:bg-primary-600 font-semibold rounded text-sm px-6 py-3"
                >
                  <svg
            ...
            <div className="grid sm:grid-cols-2  gap-16">
              ...
              <div className="flex items-start bg-white">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-sm tect-gray-400 mt-2"> +91 9793249914</p>
                </div>
              </div>
              <div className="flex items-start bg-white">
                <div className="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded p-3">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-sm tect-gray-400 mt-2">cwp.ankur@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start bg-white">
                <div className="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded p-3">
