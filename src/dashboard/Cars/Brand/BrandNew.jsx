...
import { createBrand } from "../../../store/cars/brandSlice";

const BrandNew = ({ isBrandNewModelOpen, setIsBrandNewModelOpen }) => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(createBrand(fromData, logo,setIsBrandNewModelOpen));
  };

  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow sm:px-7.5 xl:pb-1">
      <div className="flex justify-between mb-6">
        <div className="text-xl font-bold uppercase">Add new brand</div>
        <IoIosCloseCircleOutline
          className="text-2xl cursor-pointer"
          onClick={() => setIsBrandNewModelOpen(!isBrandNewModelOpen)}
        />
      </div>
