    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-primary-500 dark:text-white">
            {user?.name ?? ""}
          </span>
          {/* <span className="block text-xs">UX Designer</span> */}
        </span>

        <span className="h-12 w-12 border-zinc-100 rounded-full">
          <img
            src={user?.profile ?? UserOne}
            alt="User"
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-62 flex-col rounded-sm border border-stroke bg-white shadow-default ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="flex flex-col gap-5 border-b border-separate px-6 py-7">
          <li>
            <Link
              to="/profile"
